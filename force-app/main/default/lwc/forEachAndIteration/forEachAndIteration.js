...
export default class ForEachAndIteration extends LightningElement {
    capitals=['D.C','Berlin','Athens','Paris','London']
    car=['Tesla','BMW','Mercedes']
    ...
    customerList = [
        ...
        },
        {
            id:4,
            name:"Ahmet B.",
            phone:"+1999 999 99 99",
            email:"abayram@bayram.com",
            imgURL:"https://5.imimg.com/data5/AB/RM/HJ/SELLER-96982249/button-rose-500x500.jpg"
        }
      ]; 
